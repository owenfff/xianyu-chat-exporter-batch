...
3. Open the **Batch export** tab, enter the scan limit, or select **All**, and click **Scan conversations**. The default is 20 conversations; a positive integer scans that many, while **All** scans every conversation the page can load.
